...
class Ps_ImageSlider extends Module implements WidgetInterface
{
    ...
    protected function _postProcess()
    {
        ...
        if (Tools::isSubmit('submitSlider')) {
            ...
            /* Upload mobile images and sets slide */
            $type = '';
            $imagesize = 0;

            if (
                isset($_FILES['mobile_image_' . $language['id_lang']]) &&
            ...
            if (
                ...
                $slide->image[$language['id_lang']] = $salt . '_' . $_FILES['mobile_image_' . $language['id_lang']]['name'];
            } elseif (Tools::getValue('image_old_' . $language['id_lang']) != '') {
                $slide->image[$language['id_lang']] = Tools::getValue('image_old_' . $language['id_lang']);
            }
        }
    ...
    public function getWidgetVariables($hookName = null, array $configuration = [])
    {
        ...
        private function MobileSlider()
        {
            return (bool)(Context::getContext()->isMobile() || Context::getContext()->isTablet());
        }
    ...
    public function getSlides($active = null)
    {
        ...
        foreach ($slides as &$slide) {
            ...
            $slide['mobile_image_url'] = $this->context->link->getMediaLink(_MODULE_DIR_ . 'ps_imageslider/images/' . $slide['image']);
    ...
    public function renderAddForm()
    {
        ...
        if (Tools::isSubmit('id_slide') && $this->slideExists((int) Tools::getValue('id_slide'))) {
            ...
            $fields_form['form']['mobile_images'] = $slide->mobile_image;
